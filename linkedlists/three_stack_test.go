...
func TestMakeIntThreeStackHappyPath(t *testing.T) {
	ts := makeIntThreeStack(3)
	assert.NotNil(t, ts)

	assert.Equal(t, 3, len(ts.elements))
}

func TestIsEmptyIntThreeStackAfterCreation(t *testing.T) {
	ts := makeIntThreeStack(3)
...
func TestPushIntThreeStackNotEmpty(t *testing.T) {
	ts := makeIntThreeStack(3)
...
func TestPushIntThreeStackOverflows(t *testing.T) {
	ts := makeIntThreeStack(6)
...
func TestPeekIntThreeStack(t *testing.T) {
	ts := makeIntThreeStack(5)
...
func TestPeekEmptyIntThreeStack(t *testing.T) {
	ts := makeIntThreeStack(5)
...
func TestPopIntThreeStack(t *testing.T) {
	ts := makeIntThreeStack(5)
...
func TestPopEmptyIntThreeStack(t *testing.T) {
	ts := makeIntThreeStack(5)
...
func TestIsEmptyEmptyIntThreeStack(t *testing.T) {
	ts := makeIntThreeStack(5)
